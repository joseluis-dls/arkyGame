...
def draw_health_bar(surface, x, y, porcentaje):  #FUNCION BARRA DE VIDA
    ...
    fill = (porcentaje / 100) * BAR_LENGHT           #PARA SABER CUANTO LLENAR LA BARRA BASADO EN EL PORCENTAJE
...
class Personaje(pygame.sprite.Sprite):     #CREACION DE CLASE PARA EL PERSONAJE
    def __init__(self):             #INICIALIZAR LA CLASE
        ...
        self.image = pygame.image.load("imagenes/imagenes/arky 2.png").convert()  #AGREGANDO PERSONAJE, #COMANDO CONVERT SIRVE PARA ACELERAR EL JUEGO Y CONSUMIR MENOS RECURSOS
...
def code_nivel_2():
     class Personaje(pygame.sprite.Sprite):     #CREACION DE CLASE PARA EL PERSONAJE
                def __init__(self):             #INICIALIZAR LA CLASE
                    super().__init__()          #INICIALIZAR LA SUPER CLASE
                    self.image = evolucion #AGREGANDO PERSONAJE, #COMANDO CONVERT SIRVE PARA ACELERAR EL JUEGO Y CONSUMIR MENOS RECURSOS
...
intro_nivel_2 = pygame.image.load("imagenes/imagenes/intro nivel 2.png").convert()
pantalla_gana = pygame.image.load("imagenes/imagenes/ganador.png").convert()
evolucion = pygame.image.load("imagenes/imagenes/grad.png")
