...
def nivel3():
    ...
    instrucciones = pygame.image.load("imagenes/imagenes/instrucciones3.png").convert()
    pantalla_final = pygame.image.load("imagenes/imagenes/pantalla final.png").convert()
    intro_nivel_2 = pygame.image.load("imagenes/imagenes/intro ronda 2 lv3.png").convert()
    pantalla_gana = pygame.image.load("imagenes/imagenes/ganador3.png").convert()
    ...
    while running:
        ...
        draw_text(PANTALLA, str("Awards"), 25, W / 2.1, 53)
