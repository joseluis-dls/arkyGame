...
from pygame import *
from nivel1esp import nivel1esp
from nivel2esp import nivel2esp
from nivel3esp import nivel3esp
...
def menuesp():
    ...
    niveles = pygame.image.load("imagenes/imagenes/nivelesesp.png").convert()
    volumen = pygame.image.load("imagenes/imagenes/pantalla volumenesp.png").convert()
    pantalla_botones = pygame.image.load("imagenes/imagenes/botones pantallaesp.png").convert()
    pantalla_idioma = pygame.image.load("imagenes/imagenes/languageesp.png").convert()
    ...
    boton_ingles = pygame.Rect(280,150,140,50)
    ...
    def idioma():     #FUNCION NIVEL 2
        ...
        while waiting:          #MIENTRAS SE ESPERA
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT: sys.exit()
                if event.type == MOUSEBUTTONDOWN and event.button==1:
                    if boton_ingles.collidepoint(pygame.mouse.get_pos()):
                        sonido_boton.play()
                        running = False
            ...
            pintar_boton(PANTALLA,boton_ingles,"Volumen")
