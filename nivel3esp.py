...
def nivel3esp():
    ...
    class Personaje(pygame.sprite.Sprite):     #CREACION DE CLASE PARA EL PERSONAJE
        def __init__(self):             #INICIALIZAR LA CLASE
            ...
            self.spritesRight.append(pygame.image.load("animaciones2/arky_grad1.png").convert())  # MOVIMIENTO DERECHA; COMANDO CONVERT SIRVE PARA ACELERAR EL JUEGO Y CONSUMIR MENOS RECURSOS
            self.spritesRight.append(pygame.image.load("animaciones2/arky_grad2.png").convert())
            self.spritesRight.append(pygame.image.load("animaciones2/arky_grad3.png").convert())
            self.spritesRight.append(pygame.image.load("animaciones2/arky_grad4.png").convert())
            self.spritesRight.append(pygame.image.load("animaciones2/arky_grad5.png").convert())

            self.spritesLeft.append(pygame.image.load("animaciones2/arky_gradL1.png").convert())  # MOVIMIENTO IZQUIERDA; COMANDO CONVERT SIRVE PARA ACELERAR EL JUEGO Y CONSUMIR MENOS RECURSOS
            self.spritesLeft.append(pygame.image.load("animaciones2/arky_gradL2.png").convert())
            self.spritesLeft.append(pygame.image.load("animaciones2/arky_gradL3.png").convert())
            self.spritesLeft.append(pygame.image.load("animaciones2/arky_gradL4.png").convert())
            self.spritesLeft.append(pygame.image.load("animaciones2/arky_gradL5.png").convert())
    ...
    class Libros(pygame.sprite.Sprite):
        def __init__(self):
            ...
            self.speedy = random.randrange(2,4)  # VELOCIDAD ALEATORIA DE LOS ITEMS
    ...
    def diploma():  #FUNCION PARA INGRESAR IMAGEN
        PANTALLA.blit(diplomaf, [0,0])        #SE INGRESA IMAGEN
        pygame.display.flip()
        waiting = True       #SE COMIENZA A ESPERAR
        while waiting:       #MIENTRAS SE ESPERA
            clock.tick(60)
    ...
    libros_list = ["imagenes/imagenes/diploma_rollo.png","imagenes/imagenes/birrete nvo.png"]
    ...
    control_list = ["imagenes/imagenes/fb.png", "imagenes/imagenes/cel.png", "imagenes/imagenes/instagram.png","imagenes/imagenes/control 1.png", "imagenes/imagenes/tele 1.png"]
    ...
    items_especiales_list = ["imagenes/imagenes/trofeo.png"]
    ...
    items_especiales_list2 = ["imagenes/imagenes/trofeo.png"]
    ...
    items_especiales_list3 = ["imagenes/imagenes/trofeo.png"]
    ...
    go = pygame.image.load("imagenes/imagenes/comienzoesp.png").convert()
    instrucciones = pygame.image.load("imagenes/imagenes/instrucciones esp lv3.png").convert()
    pantalla_final = pygame.image.load("imagenes/imagenes/pantalla final.png").convert()
    intro_nivel_2 = pygame.image.load("imagenes/imagenes/intro ronda 2 lv3esp.png").convert()
    pantalla_gana = pygame.image.load("imagenes/imagenes/ganador3esp.png").convert()
    fondo2 = pygame.image.load("imagenes/imagenes/nivel2.jpeg").convert()
    fondo3 = pygame.image.load("imagenes/imagenes/fondo 3.jpeg").convert()
    diplomaf = pygame.image.load("imagenes/imagenes/diploma final.png").convert()
    fact1 = pygame.image.load("imagenes/imagenes/fact1lv3esp.png").convert()
    fact2 = pygame.image.load("imagenes/imagenes/fact2lv3esp.png").convert()
    fact3 = pygame.image.load("imagenes/imagenes/fact3lv3esp.png").convert()
    gonv3 = pygame.image.load("imagenes/imagenes/go nv3.png").convert()
    instruitemesp = pygame.image.load("imagenes/imagenes/pantalla_itmesplv3_español.png").convert()
    ...
    while running:
            ...
            if score == 30:
                ...
                class Control(pygame.sprite.Sprite):
                    def __init__(self):
                        ...
                        self.rect.x = random.randrange(W - self.rect.width) #HACER QUE APAREZCAN LOS ITEMS DE MANERA ALEATORIA EN LA PANTALLA
                        self.rect.y = random.randrange(-100, -40)    #VALOR DE BAJADA DE LOS ITEMS
                        self.speedy = random.randrange(5,6)  # VELOCIDAD ALEATORIA DE LOS ITEMS
        ...
        PANTALLA.blit(fondo3 , [0,0])  #SE INGRESA LA IMAGEN DE FONDO

        all_sprites.draw(PANTALLA)

        #CONTADOR| 
        draw_text(PANTALLA, str(score), 25, W / 1.8, 53)
        draw_text(PANTALLA, str("Premios"), 25, W / 2.1, 53)
