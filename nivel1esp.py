...
def nivel1esp():
        ...
        class Personaje(pygame.sprite.Sprite):     #CREACION DE CLASE PARA EL PERSONAJE
            def __init__(self):             #INICIALIZAR LA CLASE
                ...
                self.spritesRight.append(pygame.image.load("animaciones/arky1.png").convert())  # MOVIMIENTO DERECHA; COMANDO CONVERT SIRVE PARA ACELERAR EL JUEGO Y CONSUMIR MENOS RECURSOS
                self.spritesRight.append(pygame.image.load("animaciones/arky2.png").convert())
                self.spritesRight.append(pygame.image.load("animaciones/arky3.png").convert())
                self.spritesRight.append(pygame.image.load("animaciones/arky4.png").convert())
                self.spritesRight.append(pygame.image.load("animaciones/arky5.png").convert())

                self.spritesLeft.append(pygame.image.load("animaciones/arkyL1.png").convert())  # MOVIMIENTO IZQUIERDA; COMANDO CONVERT SIRVE PARA ACELERAR EL JUEGO Y CONSUMIR MENOS RECURSOS
                self.spritesLeft.append(pygame.image.load("animaciones/arkyL2.png").convert())
                self.spritesLeft.append(pygame.image.load("animaciones/arkyL3.png").convert())
                self.spritesLeft.append(pygame.image.load("animaciones/arkyL4.png").convert())
                self.spritesLeft.append(pygame.image.load("animaciones/arkyL5.png").convert())
        ...
        libros_list = ["imagenes/imagenes/libro 1.png", "imagenes/imagenes/libro 3.png", "imagenes/imagenes/libro 4.png", "imagenes/imagenes/libro 2.png"]
        ...
        control_list = ["imagenes/imagenes/control 1.png", "imagenes/imagenes/tele 1.png"]
        ...
        items_especiales_list = ["imagenes/imagenes/especial.png"]
        ...
        items_especiales_list2 = ["imagenes/imagenes/especial.png"]
        ...
        items_especiales_list3 = ["imagenes/imagenes/especial.png"]
        ...
        instrucciones = pygame.image.load("imagenes/imagenes/instrucciones esp.png").convert()
        pantalla_final = pygame.image.load("imagenes/imagenes/pantalla final.png").convert()
        intro_nivel_2 = pygame.image.load("imagenes/imagenes/intro ronda 2 lv1esp.png").convert()
        pantalla_gana = pygame.image.load("imagenes/imagenes/ganadoresp.png").convert()
        fact1 = pygame.image.load("imagenes/imagenes/fact1esp.png").convert()
        fact2 = pygame.image.load("imagenes/imagenes/fact2lv1esp.png").convert()
        fact3 = pygame.image.load("imagenes/imagenes/fact3lv1esp.png").convert()
        gonv1 = pygame.image.load("imagenes/imagenes/go nv1.png").convert()
        instruitemesp = pygame.image.load("imagenes/imagenes/pantalla_itmesp_español.png").convert()
        ...
        while running:
            ...
            PANTALLA.blit(fondo , [0,0])  #SE INGRESA LA IMAGEN DE FONDO

            all_sprites.draw(PANTALLA)

            #CONTADOR| 
            draw_text(PANTALLA, str(score), 25, W / 1.8, 1)
            draw_text(PANTALLA, str("Libros"), 25, W / 2.1, 1)
