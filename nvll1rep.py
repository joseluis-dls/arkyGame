...
def nivel1rep():
        ...
        class Items_especiales(pygame.sprite.Sprite):
            def __init__(self):
               ...
               self.rect.x = random.randrange(W - self.rect.width) #HACER QUE APAREZCAN LOS ITEMS DE MANERA ALEATORIA EN LA PANTALLA
               self.rect.y = random.randrange(-100, -40)    #VALOR DE BAJADA DE LOS ITEMS
               self.speedy = random.randrange(4,5)  # VELOCIDAD ALEATORIA DE LOS ITEMS
        ...
        factos_imagenes = []     #CREAMOS UNA LISTA CON TODOS LOS ITEMS PARA DESPUES ASIGANRLO A LA VARIABLE DE CONTROL_IMAGENES
        factos_list = ["imagenes/imagenes/fact1.png"]

        for img in factos_list:
            factos_imagenes.append(pygame.image.load(img).convert())
        ...
        instrucciones = pygame.image.load("imagenes/imagenes/instrucciones.png").convert()
        pantalla_final = pygame.image.load("imagenes/imagenes/pantalla final.png").convert()
        intro_nivel_2 = pygame.image.load("imagenes/imagenes/intro ronda 2 lv1.png").convert()
        pantalla_gana = pygame.image.load("imagenes/imagenes/ganador.png").convert()
