...
def nivel2esp():
    ...
    instrucciones = pygame.image.load("imagenes/imagenes/instrucciones esp lv2.png").convert()
    pantalla_final = pygame.image.load("imagenes/imagenes/pantalla final.png").convert()
    intro_nivel_2 = pygame.image.load("imagenes/imagenes/intro ronda 2 lv2esp.png").convert()
    pantalla_gana = pygame.image.load("imagenes/imagenes/ganador2esp.png").convert()
    ...
    while running:
        ...
        draw_text(PANTALLA, str("Materiales"), 25, W / 2.1, 1)
